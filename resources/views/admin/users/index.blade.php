		...
		<table class="table table-hover">
			...
			<tbody>
				...
				@if($users->count() > 0)
					...
					<tr>
						<td>
							<img src="{{ asset($user->profile->avatar) }}" class="img-responsive" width="60px" height="60px" style="border-radius: 50%;">
						</td>
						<td>
							{{ $user->name }}
						</td>
				...
				@else
					<tr>
						<th colspan="5" class="text-center">There are no Users yet</th>
					</tr>
				@endif
